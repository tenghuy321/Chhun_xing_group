        ...
        <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        <label for="name_en" class="block text-sm font-medium text-gray-700">Project Name</label>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        <label for="name_kh" class="block text-sm font-medium text-gray-700">Project Name</label>
