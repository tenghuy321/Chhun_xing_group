<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Our People</h2>
        <form action="{{ route('our_people.update', $our_people->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name.en', $our_people->name['en'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <input value="{{ old('position.en', $our_people->position['en'] ?? '') }}" type="text"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name.kh', $our_people->name['kh'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <input value="{{ old('position.kh', $our_people->position['kh'] ?? '') }}" type="text"
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $our_people->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($our_people->image) }})">
                    ...
                    <input id="dropzone-file{{ $our_people->id }}" type="file" class="hidden" name="image"
