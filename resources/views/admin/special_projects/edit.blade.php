<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Special Project</h2>
        <form action="{{ route('special_project.update', $special_project->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $special_project->title['en'] ?? '') }}" type="text"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $special_project->title['kh'] ?? '') }}" type="text"
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $special_project->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($special_project->icon) }})">
                    ...
                    <input id="dropzone-file{{ $special_project->id }}" type="file" class="hidden" name="icon"
            ...
            <div class="flex justify-between">
                <a href="{{ route('special_project.index') }}"
