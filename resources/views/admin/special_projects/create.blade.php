<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Add New Special Project</h2>
        <form action="{{ route('special_project.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div>
                <label for="dropzone-file" id="drop-area"
                    ...
                    <input id="dropzone-file" type="file" class="hidden" name="icon" accept="image/*"
