<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Add New Mission</h2>
        <form action="{{ route('mission_page.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-between w-full">
                <a href="{{ route('mission_page.index') }}"
