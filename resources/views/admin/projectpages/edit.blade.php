<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Project Content</h2>
        <form action="{{ route('projectpage.update', $projectpage->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $projectpage->title['en'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[en]" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.en', $projectpage->content['en'] ?? '') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $projectpage->title['kh'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[kh]" id="content_kh" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.kh', $projectpage->content['kh'] ?? '') }}</textarea>
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $projectpage->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($projectpage->image) }})">
                    ...
                    <input id="dropzone-file{{ $projectpage->id }}" type="file" class="hidden" name="image"
            ...
            <div class="flex justify-between">
                <a href="{{ route('projectpage.index') }}"
