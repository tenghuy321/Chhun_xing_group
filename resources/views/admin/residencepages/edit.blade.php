<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Service Content</h2>
        <form action="{{ route('residence_page.update', $residencepage->id) }}" method="POST"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $residencepage->title['en'] ?? '') }}" type="text"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $residencepage->title['kh'] ?? '') }}" type="text"
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $residencepage->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($residencepage->image) }})">
                    ...
                    <input id="dropzone-file{{ $residencepage->id }}" type="file" class="hidden" name="image"
            ...
            <div class="flex justify-between">
                <a href="{{ route('residence_page.index') }}"
