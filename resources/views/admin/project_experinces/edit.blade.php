<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Project References Content</h2>
        <form action="{{ route('project_experince.update', $project_experince->id) }}" method="POST"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        <label for="title_en" class="block text-sm font-medium text-gray-700">Project Name</label>
                        <input value="{{ old('title.en', $project_experince->title['en'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[en]" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.en', $project_experince->content['en'] ?? '') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        <label for="title_kh" class="block text-sm font-medium text-gray-700">Project Name</label>
                        <input value="{{ old('title.kh', $project_experince->title['kh'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[kh]" id="content_kh" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.kh', $project_experince->content['kh'] ?? '') }}</textarea>
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $project_experince->id }}" id="drop-area"
                    class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">

                    <input id="dropzone-file{{ $project_experince->id }}" type="file" class="hidden" name="images[]"
            ...
            <div id="img-preview"
                ...
                @php
                    $images = json_decode($project_experince->image, true);
                @endphp
    ...
    <script>
        ...
        const fileInput = document.getElementById("dropzone-file{{ $project_experince->id }}");
